...
class Button:
    ...
    A
    """
    caps_lock = CapsLock() # caps_lock is a class attribute
    ...
    def press(self):
        ...
        self.pressed += 1
        "*** YOUR CODE HERE ***"
        if Button.caps_lock.pressed % 2 != 0:  # call class attribute caps_lock's pressed attribute
...
class WinkingBear(Bear):
    ...
    def __init__(self):
        "*** YOUR CODE HERE ***"
        self.nose_and_mouth = 'ᴥ'   # super().__init__()
        self.num_eyes = 0
